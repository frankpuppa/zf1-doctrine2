  ...
  render() {
    return (
      <div className="form-group">
        ...
        <input className="form-control" type={this.props.inputType} id={this.props.id} onChange={this.changeHandler} />
      </div>
    )
  }
}
  ...
  render() {
    return (
      <form>
        ...
        <button className="btn btn-primary" onClick={this.clickHandler}>{this.props.buttonName}</button>
      </form>
    )
  }
}
  ...
  render() {
    return (
      <div>
        ...
        <Footer text="To log into the page!!"/>
      </div>
    )
  }
}
